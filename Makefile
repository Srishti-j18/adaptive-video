...
fabric:
	pandoc --resource-path=notebooks/ --self-contained --wrap=none -i notebooks/title.md notebooks/intro_fabric.md \
		...
		notebooks/exec_interruption.md notebooks/exec_vary.md \
...
chameleon:
	pandoc  --resource-path=notebooks/ --self-contained --wrap=none -i notebooks/title.md notebooks/intro_chameleon.md \
		...
		notebooks/exec_cbr.md notebooks/data_analysis_fabric.md notebooks/exec_interruption.md notebooks/exec_vary.md \
		notebooks/exercises.md notebooks/go_further.md \
